...
plan_client = rospy.ServiceProxy('/plan', Planner_srv)
control_client = rospy.ServiceProxy('/control', Controller_srv)
plan = Planner_srvRequest()
plan_res = Planner_srvResponse()
control = Controller_srvRequest()
